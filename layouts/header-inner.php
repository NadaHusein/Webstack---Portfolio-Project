...
<header>
    <div class="menu">
        <nav class="navbar navbar-expand-lg fixed-top inner">
            <div class="container-xxl">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="archive-about.html">Flights</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="firstNavbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="#">Outcoming</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="secondNavbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="#">Sightseeing</a></li>
                                <li><a class="dropdown-item" href="transportation.html">Car Rental</a></li>
                                <li><a class="dropdown-item" href="visa.html">Visa</a></li>
                            </ul>
                        </li>


                        <li class="nav-item"><a class="nav-link" href="archive-about.html">Nile Cruise</a></li>
                        <li class="nav-item"><a class="nav-link" href="archive-about.html">Gallery</a></li>
